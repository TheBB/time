...
class TimekeeperWindow(pyglet.window.Window):
    ...
    def construct_system(self):
        ...
        self.helion_vl = pyglet.graphics.vertex_list(2, 'v2f', ('c3B', [80, 80, 80] * 2))
        ...
        self.equinox_vl = pyglet.graphics.vertex_list(2, 'v2f', ('c3B', [80, 80, 80] * 2))
        ...
        self.solstice_vl = pyglet.graphics.vertex_list(2, 'v2f', ('c3B', [80, 80, 80] * 2))
